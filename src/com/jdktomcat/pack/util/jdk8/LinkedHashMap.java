package com.jdktomcat.pack.util.jdk8;
...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
    ...
    final class LinkedKeyIterator extends LinkedHashMap.LinkedHashIterator implements Iterator<K> {
        @Override
        public final K next() {
    ...
    final class LinkedValueIterator extends LinkedHashMap.LinkedHashIterator implements Iterator<V> {
        @Override
        public final V next() {
