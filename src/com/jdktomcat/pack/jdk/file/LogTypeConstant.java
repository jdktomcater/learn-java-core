...
public class LogTypeConstant {
     ...
     *  转手动出款
     */
    public static final int W_O_CHANGE_HAND_OUT = 3;
     ...
     * 确认提款
     */
    public static final int O_STATUS_CONFIRM_WITHDRAW = 41;
     ...
     * 取消加入最优先匹配池
     */
    public static final int CANCEL_JOIN_MOST_PRIORITY = 94;

    /**
     * 合天下转3方出款
     */
    public static final int CHANGE_THIRD_OUT = 502;

    /**
     * 分配至极速
     */
    public static final int DISTRIBUTION_MATCHUP = 602;

    /**
     * 极速提款订单-创建
     */
    public static final int W_O_STATUS_MATCHUP_CREATE = 603;
}
